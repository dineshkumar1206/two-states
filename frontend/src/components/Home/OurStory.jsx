      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 items-center lg:items-start">
          ...
          <div className="flex flex-col" data-aos="fade-right" data-aos-duration="1200" data-aos-once="false">
            ...
            {/* Multi-colored text */}
            <div className="mt-8 text-[15px] sm:text-base lg:text-[17px] font-medium text-gray-500 leading-relaxed space-y-1.5">
              ...
              <p className="pt-3 text-gray-500 font-bold text-base sm:text-lg">And 2 States brings them all to the same table.</p>
            </div>

            {/* Paragraph */}
            <p className="mt-6 text-sm sm:text-base lg:text-[16px] text-gray-500 leading-[1.7] pr-0 md:pr-4 font-medium">
          ...
          <div className="flex flex-col" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="400" data-aos-once="false">
            ...
            {/* Paragraphs */}
            <p className="mt-8 text-sm sm:text-base lg:text-[16px] text-gray-500 leading-[1.7] font-medium">
