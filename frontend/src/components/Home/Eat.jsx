    ...
    <div id="contact" ref={containerRef} className="relative w-full h-screen min-h-[700px] max-h-[1000px] font-poppins z-10 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden pointer-events-none">
        <motion.img 
          ...
          alt="Cafeteria"
          className="w-[120%] max-w-none h-full object-cover object-bottom"
          style={{ 
      ...
      <div className="relative w-full max-w-4xl mx-auto px-4 md:px-8 flex flex-col items-center text-center z-20 mt-[-5%]">
        ...
        <div className="max-w-3xl mx-auto text-[#134954] font-medium text-[15px] md:text-[17px] leading-relaxed space-y-6 mb-10" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="450" data-aos-once="false">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="600" data-aos-once="false">
            {/* WhatsApp Button (Let's Talk) */}
            <a href="https://wa.me/919833381022" target="_blank" rel="noopener noreferrer" 
               className="bg-[#00b5cc] hover:bg-[#009fb3] text-white font-bold text-sm md:text-base px-6 md:px-8 py-2.5 md:py-3 rounded-full flex items-center shadow-[0_4px_0_#fbce3a] active:shadow-[0_0px_0_#fbce3a] active:translate-y-[4px] transition-all duration-300 gap-1.5 md:gap-2">
              ...
              {/* Separator */}
              <div className="w-[1px] h-5 bg-white/40 mx-1 rounded-full"></div>
              
              {/* Text */}
              <span className="tracking-wider">LET'S TALK</span>
              
              {/* Right Arrow */}
              <svg className="w-5 h-5 text-[#fbce3a]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
